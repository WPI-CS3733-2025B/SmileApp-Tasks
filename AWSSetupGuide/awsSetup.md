## AWS Setup Guide - CS 3733 2025 C Term
Vivek Jagadeesh
### Overview
...
9. Finally, in the additional configuration options (at the end of the file), add an initial database name of postgres, and change the backup retention period to 0 days.
